...
tsneOptimize = function (data_object, feature_varaible, usage = "explore", dim_output = 2, neighbors = c(5, 10, 15, 30, 50, 100), add_pca = TRUE, theta_value = 0.25, duplicates = TRUE) {
